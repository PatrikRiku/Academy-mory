...
public class AcademyMoryApplication {
    ...
    @GetMapping("/highscore/{score}/{name}")
    @ResponseBody
    public int highScore(@PathVariable int score, @PathVariable String name) throws Exception {
        dbconnectmem.addHighscore(score, name);
        return score;
    }
